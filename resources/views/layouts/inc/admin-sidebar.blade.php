    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link {{ Request::is('admin/category') || Request::is('admin/edit-category/*') || Request::is('admin/add-category') ? 'collapsed active' :'collapsed' }}"
                ...
                <a class="nav-link {{ Request::is('admin/posts') || Request::is('admin/post/*') || Request::is('admin/add-post') ? 'collapsed active' : '' }}"
                ...
                <div class="collapse {{ Request::is('admin/add-post') || Request::is('admin/posts')  ? 'show' : '' }}"
